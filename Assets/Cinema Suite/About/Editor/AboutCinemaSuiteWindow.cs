...
public class AboutCinemaSuiteWindow : EditorWindow
{
    ...
    public void Awake()
    {
        ...
        isMocapInstalled = System.IO.File.Exists("Assets/Cinema Suite/Cinema Mocap/System/Editor/CinemaMocap.dll");
        if (isMocapInstalled)
        {
            mocapProductVersion = FileVersionInfo.GetVersionInfo("Assets/Cinema Suite/Cinema Mocap/System/Editor/CinemaMocap.dll").ProductVersion;
        }
